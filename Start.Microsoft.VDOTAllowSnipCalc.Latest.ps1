<#
.SYNOPSIS
    Run VDOT Cleanup, keeping Snipping Tool and Calculator
.DESCRIPTION
    This script downloads and runs VDOT Cleanup on a Windows machine.
    Variant of Start.Microsoft.VDOT.Latest.ps1: identical AppxPackages.json config, except
    Microsoft.ScreenSketch (Snipping Tool / Snip & Sketch) and Microsoft.WindowsCalculator
    are left "Unchanged" instead of "Disabled".
.NOTES
...
[
  ...
  },
  {
    ...
    "Description": "Snip and Sketch app (Snipping Tool) - kept for this variant"
  },
  {
  ...
  },
  {
    ...
    "Description": "Microsoft Calculator app - kept for this variant"
  },
  {
